...
def plot_G_node_color_simple(subinfectG,nodelist):
    # initG = commons.get_networkByFile('../../../data/2regular_tree.txt')
    # nx.draw_networkx(G, node_size=0.1)
    plt.figure(figsize=(20,20))
    pos = nx.spring_layout(subinfectG)  # positions for all nodes
    nodelist_all_graph =[]  #图的总节点数目
    ...
    nx.draw_networkx_edges(subinfectG, pos, edgelist=edge_list, alpha=0.4)
