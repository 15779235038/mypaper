...
if __name__ == '__main__':
    ...
    logger = log.Logger(logname='../data/main_graph_Email-Enron0104.log', loglevel=logging.INFO, logger="experiment").get_log()
    experiment = Experiment(methods, logger)
    experiment.propagation_model = 'SI'

    start_time = clock()
    print "Starting..."
    d = data.Graph("../data/wugulidata/graph_Email-Enron.txt", weighted=0)
    d.debug = False
    test_num = 100
