...
if __name__ == '__main__':
    ...
    logger = log.Logger(logname='../data/main_500random_graph001.log', loglevel=logging.INFO, logger="experiment").get_log()
    ...
    d = data.Graph("../data/random_graph/500/500random_graph001.txt", weighted=0)
    d.debug = False
    test_num = 100

    print 'Graph size: ', d.graph.number_of_nodes(), d.graph.number_of_edges()
    test_category = experiment.RANDOM_TEST
    experiment.start(d, test_category, test_num, 50,110,10)
