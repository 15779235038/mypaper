...
if __name__ == '__main__':
    ...
    logger = log.Logger(logname='../data/main_5000random_graph0005.log', loglevel=logging.INFO, logger="experiment").get_log()
    experiment = Experiment(methods, logger)
    experiment.propagation_model = 'SI'

    start_time = clock()
    print "Starting..."
    d = data.Graph("../data/random_graph/5000/5000random_graph0005.txt", weighted=0)
    d.debug = False
    test_num = 10

    print 'Graph size: ', d.graph.number_of_nodes(), d.graph.number_of_edges()
    test_category = experiment.RANDOM_TEST
    experiment.start(d, test_category, test_num, 300,350,50)
